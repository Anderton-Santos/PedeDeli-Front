...
//     return (
//         <div className="container mx-auto w-full h-screen p-8">
//             <h1>Produtos cadastrados</h1>
//             <section className="flex flex-col gap-12">
//                 <div className="flex justify-around w-[50%] mx-auto text-xl font-extrabold text-gray-400">
//                     <button>Retirada</button>
//                     <button>Encomendas</button>
//                 </div>

//                 {/* <div className="flex items-center justify-center mx-auto gap-6 text-[18px] font-bold  bg-gray-600 w-fit py-2 px-6 text-gray-300 rounded-2xl"> */}
//                 <div className="flex items-center justify-center mx-auto gap-6 text-[18px] font-bold  bg-gray-600 w-fit py-2 px-6 text-gray-300 rounded-2xl">
...
//             <section>
//                 <h1 className="p-16 text-center text-3xl font-black">Produtos</h1>

//                 <section className="grid grid-cols-4 gap-8 justify-center items-center">

//                     <div className="bg-amber-400 w-[350px] h-[280px]">
//                         <div className="bg-gray-950 w-[350px] h-[200px]">
...
//                                 <span className='text-[20px] font-medium'>Bolo de cenoura</span>
//                                 <span className='text-[20px]'>Preço:</span>
//                             </section>


//                             <button className='flex items-center  justify-center bg-amber-200 w-[40px] h-[48px] rounded-[8px]'><ShoppingCart size={30} /></button>
//                         </div>
